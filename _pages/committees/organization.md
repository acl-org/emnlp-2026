...
Contact: emnlp2026-programchairs@googlegroups.com
{% include committee-member.html
   name="Hung-Yi Lee"
...
{% include committee-member.html
   ...
   picture="/assets/images/committee/jessy_li.jpg"
%}
{% include committee-member.html
...
{% include committee-member.html
   ...
   picture="/assets/images/committee/LV_portré_wb.jpg"
%}
{% include committee-member.html
...
{% include committee-member.html
   name="Alberto Abad"
   institution="INESC-ID and Instituto Superior Técnico"
   role="Demonstration Chairs"
...
{% include committee-member.html
   ...
   role="Diversity and Inclusion Chairs"
   site="https://dadelani.github.io/"
   picture="/assets/images/committee/david_adelani.png"
%}
{% include committee-member.html
   name="Spandana Gella"
